        ...
        <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-6 fh5co-tours3 animate-box" data-animate-effect="fadeIn">
                    <div href="{{route('EventsProperties',['searchslug'=>$events->SearchKeyWords,'siteslug'=>$events->EventName,'cityslug'=>$events->City])}}"><img src="https://panobooking.com/AndroidFiles/EventsThumbnail/{{$events->EventName}}.jpg"  class="img-responsive" onerror="this.onerror=null;this.src='images/place-2.jpg';">
                        <div class="desc">
                            <span></span>
                            <h3><a  href="{{route('EventsDetails',['searchslug'=>$events->ID])}}">{{$events->EventName}}</a></h3>
                            <span>{{$events->Country}}</span>
                            <a class="btn btn-primary btn-outline" href="{{route('EventsProperties',['searchslug'=>$events->SearchKeyWords,'siteslug'=>$events->EventName,'cityslug'=>$events->City])}}">View Nearby Properties<i class="icon-arrow-right22"></i></a>
                        </div>
                    </div>
                </div>    
                @endforeach 

    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8 col-md-offset-2 text-center heading-section animate-box">
                <h3>{{request()->input('siteslug')}} Event Stays</h3>
            <p>{{$hotelsearched->count()}} Stays ready to be booked for {{request()->input('siteslug')}} Event</p>
            </div>
        </div>
...
<div id="fh5co-tours" class="fh5co-section-gray">
    <div class="container">
        <div class="row">
            <div class="col-md-8 col-md-offset-2 text-center heading-section animate-box">
                <h3>{{request()->input('siteslug')}} Event Rental Cars</h3>
                <p>{{$carsearched->count()}} Rental Cars ready to be booked for {{request()->input('siteslug')}}</p>
            </div>
        </div>
        <div class="row">
...
<div id="fh5co-tours" class="fh5co-section-gray">
    <div class="container">
        <div class="row">
            <div class="col-md-8 col-md-offset-2 text-center heading-section animate-box">
                <h3>{{request()->input('siteslug')}} Event Airport Taxis</h3>
                <p>{{$taxisearched->count()}} Airport Taxis ready for Airport transfers to {{request()->input('siteslug')}} Event</p>
            </div>
        </div>
        <div class="row">
...
<div id="fh5co-tours" class="fh5co-section-gray">
    <div class="container">
        <div class="row">
            <div class="col-md-8 col-md-offset-2 text-center heading-section animate-box">
                <h3>{{request()->input('siteslug')}} Event Ambulances</h3>
                <p>{{$ambulancesearched->count()}} Ambulances ready for any Emergency need at {{request()->input('siteslug')}} Event</p>
            </div>
        </div>
        <div class="row">
            <div class="owl-carousel taxifeatured-carousel owl-theme">

                        ...
                        <div class="shop-widget">
                            <div class="shop-widget-top">
                                <aside class="widget widget-categories">
                                    <h2 class="sidebar-title text-center">Airport Taxi Categories</h2>
                                    <ul class="sidebar-menu">
                                        @foreach ($firstdestinations as $destination )
									    <li>
                                        <a href='{{route('TaxisList',['taxicategoriesslug'=>$destination[0]->CarCategory])}}'>
                                           ...
                                           <div class='col-md-4 col-sm-6'>
											   <div class='single-banner'>
												   <div class='product-wrapper'>
													   <a href='{{route('TaxiDetails',['taxislug'=>$carcategory->IDs])}}' class='single-banner-image-wrapper'>
													   ...
													   <div class='product-description'>
														   <div class='functional-buttons'>
															   <a href='{{route('TaxiDetails',['taxislug'=>$carcategory->IDs])}}' title='Reserve'>
												   ...
												   <div class='banner-bottom2 text-center'>
													   <div class='banner-bottom-title'>
														   <a href='{{route('TaxiDetails',['taxislug'=>$carcategory->IDs])}}'>{{$carcategory->TaxiNo}}</a>
													   </div>
                                       ...
                                       <div class='row'>
                                           <div class='single-shop-product'>
                                               <div class='col-xs-12 col-sm-5 col-md-6'>
                                                   <div class='left-item'>
                                                       <a href='{{route('TaxiDetails',['taxislug'=>$carcategory->IDs])}}' title='{{$carcategory->TaxiNo}}'>
                                               ...
                                               <div class='col-xs-12 col-sm-7 col-md-6'>
                                                   <div class='deal-product-content'>
                                                       <h4>
                                                           <a href='{{route('TaxiDetails',['taxislug'=>$carcategory->IDs])}}' title='{{$carcategory->TaxiNo}}'>{{$carcategory->TaxiNo}}</a>
                                                       </h4>
                                                       ...
                                                       <div class='availability'>
                                                           <span>Available</span>
                                                           <span><a href='{{route('TaxiDetails',['taxislug'=>$carcategory->IDs])}}'>Reserve</a></span>
                                                       </div>
                                                   </div>
                                               </div>
                                           </div>  

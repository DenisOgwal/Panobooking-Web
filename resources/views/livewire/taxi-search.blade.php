    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 col-md-offset-2 text-center heading-section animate-box">
                ...
                <p>{{$taxisearched->count()}} Results for {{request()->input('airport')}} Taxi Search</p>
            </div>
        </div>
        <div class="row" wire:ignore.self>
            @foreach ($taxisearched as $taxisearch)
            <div class="col-md-4 col-sm-6 fh5co-tours animate-box" data-animate-effect="fadeIn">
                <div href="{{route('TaxiDetails',['taxislug'=>$taxisearch->IDs])}}"><img src="https://panobooking.com/AndroidDriver/FileUpload/{{$taxisearch->TaxiNo}}.jpg"  class="img-responsive" onerror="this.onerror=null;this.src='images/image-placeholder.png';"/>
                    <div class="desc">
                        <span></span>
                        <h3>{{$taxisearch->TaxiNo}}</h3>
                        <span>{{$taxisearch->CarSpec}}</span>
                        <span>{{$taxisearch->CurrentLocation}}</span>
                        <a class="btn btn-primary btn-outline" href="{{route('TaxiDetails',['taxislug'=>$taxisearch->IDs])}}">Order Now <i class="icon-arrow-right22"></i></a>
                    </div>
                </div>
            </div>   
            @endforeach

        ...
        <div  class="row">
                ...
                <div class="single-product-image-inner">
                    ...
                    <div class="tab-content">
                        ...
                        <div role="tabpanel" class="tab-pane active" id="{{$i}}">
                            ...
                            <img src='https://panobooking.com/AndroidFiles/EventsThumbnail/{{$tourismsites->EventName}}.jpg'  style='height: auto;width:100%;border-radius:10px;' onerror="this.onerror=null;this.src='images/place-2.jpg';"/>
                            </a>
                        </div>
                    </div>
                        @else
                        ...
                        <div role="tabpanel" class="tab-pane" id="{{$i}}">
                            <a class='venobox' href='' data-gall='gallery' title=''>
                            <img src='https://panobooking.com/AndroidFiles/EventsThumbnail/{{$tourismsites->EventName}}{{$i}}.jpg'  style='height: auto;width:100%;border-radius:10px;' onerror="this.onerror=null;this.src='images/place-2.jpg';"/>
                            </a>
                        </div>
                    </div>
                        @endif
            ...
            <div class="col-md-6 col-sm-5">
                <div class="single-product-details" style="margin-top:20px;">
                    <h2>{{$tourismsites->EventName}}</h2>
                    <p>{{$tourismsites->City}} ->{{$tourismsites->Country}}</p>
                    <h4>Start Date:<span>{{$tourismsites->StartDate}}</span></h4>
                    <h4>End Date:<span>{{$tourismsites->EndDate}}</span><h4>
                    <div class="col-md-12 text-center animate-box" style="margin-bottom:20px;">
                        <p><a class="btn btn-primary btn-outline btn-lg" href="{{route('EventsProperties',['searchslug'=>$tourismsites->SearchKeyWords,'siteslug'=>$tourismsites->EventName,'cityslug'=>$tourismsites->City])}}">View Nearby Properties<i class="icon-arrow-right22"></i></a></p>
                    </div>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8 col-md-offset-2 text-center heading-section animate-box">
                ...
                <p>More of the events, more of  entertainment,Is it a business Event?, Name it. Here are some of the Events upcoming. And with Panobooking as a partner we are here to help you fnd the Right Accomodation, Travel Cars and Many more. Try and book with us now.</p>
            </div>
        </div>
    </div>
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 col-md-4 col-sm-6" style="width:100%;">
                <div class="fh5co-blog animate-box" >
                    <a href="{{route('EventsProperties',['searchslug'=>$tourismsites->SearchKeyWords,'siteslug'=>$tourismsites->EventName,'cityslug'=>$tourismsites->City])}}"><img class="img-responsive" src="https://panobooking.com/AndroidFiles/EventsThumbnail/{{$tourismsites->EventName}}.jpg" onerror="this.onerror=null;this.src='images/place-2.jpg';"/></a>        
                    <div class="blog-text">
                        <div class="prod-title">
                            <h3><a href="{{route('EventsProperties',['searchslug'=>$tourismsites->SearchKeyWords,'siteslug'=>$tourismsites->EventName,'cityslug'=>$tourismsites->City])}}">{!!Str::limit($tourismsites->EventName,25)!!}</a></h3>
                            <p>{!!Str::limit($tourismsites->ShortDescription,95)!!}</p>
                            <p><a href="{{route('EventsDetails',['searchslug'=>$tourismsites->ID])}}">Learn More...</a></p>
                        </div>
                    </div> 
                </div>
            </div>
        ...
        <div class="col-md-12 text-center animate-box">
            <p><a class="btn btn-primary btn-outline btn-lg" href="/Events">View All Upcoming Events<i class="icon-arrow-right22"></i></a></p>
        </div>
    </div>       
    </div>
</div>

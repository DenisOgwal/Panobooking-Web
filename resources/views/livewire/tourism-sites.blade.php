...
<div id="fh5co-tours" class="fh5co-section-gray">
    <div class="container">
        <div class="row">
            ...
            <div class="row">
                @foreach ($tourismsites as $tourismsite)
                <div class="col-md-4 col-sm-6 fh5co-tours3 animate-box" data-animate-effect="fadeIn">
                    <div><a  href="{{route('TourismSiteDetails',['searchslug'=>$tourismsite->ID])}}"><img src="https://panobooking.com/AndroidFiles/TourismSiteThumbnail/{{$tourismsite->SiteName}}.jpg"  class="img-responsive" onerror="this.onerror=null;this.src='images/place-2.jpg';">
                        <div class="desc">
                            <span></span>
                            <h3><a  href="{{route('TourismSiteDetails',['searchslug'=>$tourismsite->ID])}}">{{$tourismsite->SiteName}}</a></h3>
                            <span>{{$tourismsite->Country}}</span>
                            {{--<span class="price">{{$destinations->Country}}</span>--}}
                            <a class="btn btn-primary btn-outline" href="{{route('TourismProperties',['searchslug'=>$tourismsite->SearchKeyWords,'siteslug'=>$tourismsite->SiteName,'cityslug'=>$tourismsite->City])}}">View Nearby Properties<i class="icon-arrow-right22"></i></a>
                        </div>
                    </div>

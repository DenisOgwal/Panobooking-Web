                ...
                <div class="row">
                    <div class="col-sm-5 col-md-5">
                        ...
                        <div id="mydesc" class="col-sm-7 col-sm-push-1 col-md-7 col-md-push-1">
                            ...
                            <h3>Readily Available Rental Car</h3>
                            <span class="price">{{$offeredroom->TaxiNo}}</span>
                            <p><a class="btn btn-info btn-lg" href="{{route('CarDetails',['carslug'=>$offeredroom->IDs])}}">Rent Now</a></p>
                            @endforeach
                        </div>
                        @else
                        <div id="mydesc" class="col-sm-7 col-sm-push-1 col-md-7 col-md-push-1">
                            <p>Ranked by <a href="panobooking.com" target="_blank" class="fh5co-site-name">panobooking.com</a></p>
                            <h3>Featured Car on Panobooking.com</h3>
                            @foreach ($hoteloffered as $hoteloffered)
                            <span class="price">{{$hoteloffered->TaxiNo}}</span>
                            <p><a class="btn btn-info btn-lg" href="{{route('CarDetails',['carslug'=>$hoteloffered->IDs])}}">Rent Now</a></p>
                            @endforeach
                        </div>
                        @endif
                </div>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8 col-md-offset-2 text-center heading-section animate-box">
                <h3>Ready Cars For Rent</h3>
                <p>You Need a Private Car ride, We have you covered. Explore the best cars for all your needs.</p>
            </div>
        </div>
        <div class="row">
            <div class="owl-carousel taxifeatured-carousel owl-theme"  style="color:black;">
                ...
                <div class="col-md-4 col-sm-6 fh5co-tours animate-box" style="width:100%;" data-animate-effect="fadeIn">
                    <div  href="{{route('CarDetails',['carslug'=>$car->IDs])}}"><img src="https://panobooking.com/AndroidDriver/FileUpload/{{$car->DriverName}}{{$car->TaxiNo}}.jpg"  class="img-responsive" onerror="this.onerror=null;this.src='images/image-placeholder.png';"/>
                        <div class="desc">
                            <span></span>
                            <h3>{{$car->TaxiNo}}</h3>
                            <span class="price">{!!$currencypick!!}  
                                @if($currencypick=="UGX"){{number_format($car->Price/$currenyvalue,0)}}
                                @else{{number_format(ceil($car->Price/$currenyvalue),0)}}
                                @endif </span>
                            <a class="btn btn-primary btn-outline" href="{{route('CarDetails',['carslug'=>$car->IDs])}}">Rent Now <i class="icon-arrow-right22"></i></a>
                        </div>
                    </div>
                </div> 
            </div>  
            ...
            <div class="col-md-12">
                <ul id="fh5co-destination-list" class="animate-box">
                    ...
                    <li class="one-forth text-center" style="background-image: url('https://panobooking.com/AndroidDriver/FileUpload/CarCategory/{{$destination->CarCategory}}.jpg'); ">
                        <a href="{{route('CarsList',['carcategoriesslug'=>$destination->CarCategory ])}}">
                   ...
                   @endforeach
                    <li class="one-half text-center">
                        <div class="title-bg">
                            <div class="case-studies-summary">
                                ...
                                <span><a href="{{route('CarsList')}}">View All Categories</a></span>
                            </div>
                        </div>
                    </li>
                    ...
                    <li class="one-forth text-center" style="background-image: url('https://panobooking.com/AndroidDriver/FileUpload/CarCategory/{{$destinations->CarCategory}}.jpg'); ">
                        <a href="{{route('CarsList',['carcategoriesslug'=>$destinations->CarCategory ])}}">
                            <div class="case-studies-summary">

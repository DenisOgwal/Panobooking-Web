    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 col-md-offset-2 text-center heading-section animate-box">
                <h3>Stays Search</h3>
                <p>{{$hotelsearched->count()}} Results Displayed for {{request()->input('from_city')}} Stays Search</p>
            </div>
        </div>
            <div class="row">
...
<div wire:ignore id="fh5co-tours" class="fh5co-section-gray">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8 col-md-offset-2 text-center heading-section animate-box">
                <h3>Instead Look at our Featured Stays</h3>
                <p>Take a Look at the Featured Stays, with a good price offer yet good services.</p>
            </div>
        </div>
...
<div wire:ignore id="fh5co-tours" class="fh5co-section-gray">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8 col-md-offset-2 text-center heading-section animate-box">
                <h3>You could also check from Trending Properties</h3>

    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8 col-md-offset-2 text-center heading-section animate-box">
                <h3>{{request()->input('siteslug')}} Stays</h3>
            <p>{{$hotelsearched->count()}} Stays Around {{request()->input('siteslug')}}</p>
            </div>
        </div>
...
<div id="fh5co-tours" class="fh5co-section-gray">
    <div class="container">
        <div class="row">
            <div class="col-md-8 col-md-offset-2 text-center heading-section animate-box">
                <h3>{{request()->input('siteslug')}} Rental Cars</h3>
                <p>{{$carsearched->count()}} Rental Cars Around {{request()->input('siteslug')}}</p>
            </div>
        </div>
        <div class="row">
...
<div id="fh5co-tours" class="fh5co-section-gray">
    <div class="container">
        <div class="row">
            <div class="col-md-8 col-md-offset-2 text-center heading-section animate-box">
                <h3>{{request()->input('siteslug')}} Airport Taxis</h3>
                <p>{{$taxisearched->count()}} Airport Taxis Around {{request()->input('siteslug')}}</p>
            </div>
        </div>
        <div class="row">
...
<div id="fh5co-tours" class="fh5co-section-gray">
    <div class="container">
        <div class="row">
            <div class="col-md-8 col-md-offset-2 text-center heading-section animate-box">
                <h3>{{request()->input('siteslug')}} Ambulances</h3>
                <p>{{$ambulancesearched->count()}} Ambulances Around {{request()->input('siteslug')}}</p>
            </div>
        </div>
        <div class="row">
            <div class="owl-carousel taxifeatured-carousel owl-theme">

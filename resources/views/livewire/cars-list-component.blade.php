                        ...
                        <div class="shop-widget">
                            <div class="shop-widget-top">
                                <aside class="widget widget-categories">
                                    <h2 class="sidebar-title text-center">Car Categories</h2>
                                    <ul class="sidebar-menu">
                                        @foreach ($firstdestinations as $destination )
									    <li>
                                        <a href='{{route('CarsList',['carcategoriesslug'=>$destination[0]->CarCategory])}}'>
                                            <i class='fa fa-angle-double-right'></i>{{ $destination[0]->CarCategory }}<span>({{$destination[0]->cnt}})</span>
                                        </a>
                                        </li>
                                        @endforeach                                             
                                    </ul>
                                           ...
                                           <div class='col-md-4 col-sm-6'>
											   <div class='single-banner'>
												   <div class='product-wrapper'>
													   <a href='{{route('CarDetails',['carslug'=>$carcategory->IDs])}}' class='single-banner-image-wrapper'>
														   <img  src="https://panobooking.com/AndroidDriver/FileUpload/{{$carcategory->DriverName}}{{$carcategory->TaxiNo}}.jpg" style="Height:180px; width:100%;border-radius:10px;" onerror="this.onerror=null;this.src='images/image-placeholder.png';"/>
														   <div class='price'><span>{!!$currencypick!!}.</span>{{number_format(ceil($carcategory->Price/$currenyvalue),0)}}</div>
													</a>
													   <div class='product-description'>
														   <div class='functional-buttons'>
															   <a href='{{route('CarDetails',['carslug'=>$carcategory->IDs])}}' title='Reserve'>
												   ...
												   <div class='banner-bottom2 text-center'>
													   <div class='banner-bottom-title'>
														   <a href='{{route('CarDetails',['carslug'=>$carcategory->IDs])}}'>{{$carcategory->TaxiNo}}</a>
													   </div>
                                                       @if($carcategory->Ratings==5)
                                       ...
                                       <div class='row'>
                                           <div class='single-shop-product'>
                                               <div class='col-xs-12 col-sm-5 col-md-6'>
                                                   <div class='left-item'>
                                                       <a href='{{route('CarDetails',['carslug'=>$carcategory->IDs])}}' title='{{$carcategory->TaxiNo}}'>
                                                           <img src='https://panobooking.com/AndroidDriver/FileUpload/{{$carcategory->DriverName}}{{$carcategory->TaxiNo}}.jpg' style='Height:250px;width:100%;border-radius:10px;' onerror="this.onerror=null;this.src='images/image-placeholder.png';"/>
                                                       </a>
                                                   </div>
                                               </div>
                                               <div class='col-xs-12 col-sm-7 col-md-6'>
                                                   <div class='deal-product-content'>
                                                       <h4>
                                                           <a href='{{route('CarDetails',['carslug'=>$carcategory->IDs])}}' title='{{$carcategory->TaxiNo}}'>{{$carcategory->TaxiNo}}</a>
                                                       </h4>
                                                       <div class='product-price'>
                                                           <span class='new-price'> {!!$currencypick!!}. {{number_format(ceil($carcategory->Price/$currenyvalue),0)}}</span>
                                                       ...
                                                       <p>{{ $carcategory->CarSpec}}</p>
                                                       <div class='availability'>
                                                           <span>Available</span>
                                                           <span><a href='{{route('CarDetails',['carslug'=>$carcategory->IDs])}}'>Reserve</a></span>
                                                       </div>
                                                   </div>
                                               </div>
                                           </div>  

                ...
                <div class="row">
                    <div class="col-sm-5 col-md-5">
                          ...
                          <!-- Nav tabs -->
                           <ul class="nav nav-tabs" role="tablist">
                            <li role="presentation"  class="active">
                                <a href="#guesthouse" aria-controls="guesthouse" role="tab" data-toggle="tab" >Guest House</a>
                           </li>
                           ...
                           <!-- Tab panes -->
                            <div class="tab-content">
                                <div role="tabpanel" class="tab-pane  active" id="guesthouse">
                                    <div class="row">
                                        <form name="GuestSearch" action="{{route('HomeGuestSearch')}}" >
                                        <div class="col-xxs-12 col-xs-12 mt">
                                            <div class="input-field">
                                                <label for="from">Enter Destination:</label>
                                                <input type="text" class="form-control" id="Destination" name="Destination" value="{{ request()->input('Destination') }}" placeholder="Destination"/>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                       ...
                                       <div class="col-xxs-12 col-xs-12 mt">
                                           <div class="input-field">
                                               ...
                                               <input type="text" class="form-control" name="from_city" id="from_city" value="{{ request()->input('from_city') }}" {{--wire:model="from_city"--}} placeholder="Fortportal, Uganda"/>
                                           </div>
                                       </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <section>
                                            ...
                                            <select class="cs-select cs-skin-border" name="NoOfPeople" id="NoOfPeople">
                        ...
                        <div id="mydesc" class="col-sm-7 col-sm-push-1 col-md-7 col-md-push-1">
                            ...
                            <h3>Home Guest House in {{$offeredroom->Place}}</h3>
                            <span class="price">UGX {{$offeredroom->Prices}}</span>
                            <p><a class="btn btn-info btn-lg" href="#">Get it Now</a></p>
                            @endforeach
                        </div>
                        @else
                        <div id="mydesc" class="col-sm-7 col-sm-push-1 col-md-7 col-md-push-1">
                            <p>Ranked by <a href="panobooking.com" target="_blank" class="fh5co-site-name">panobooking.com</a></p>
                            <h3>Trending Home Guest House on Panobooking.com</h3>
                            @foreach ($hoteloffered as $hoteloffered)
                            <h3>{{$hoteloffered->GuestHouseName}}</h3>
                            <span class="price">Least Price UGX {{$hoteloffered->Prices}}</span>
                            <p><a class="btn btn-info btn-lg" href="#">Check it Out</a></p>
                            @endforeach
                        </div>
                        @endif
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8 col-md-offset-2 text-center heading-section animate-box">
                <h3>Trending Guest Houses</h3>
                <p>These are the Top Trending Deals of the day, with a good price offer yet good Home Guest House.</p>
            </div>
        </div>
        <div class="row">
            <div class="owl-carousel featured-carousel owl-theme"  style="color:black;">
           @foreach ($guesthousess as $guesthouse)
            <div class="col-md-4 col-sm-6 fh5co-tours animate-box" style="width:100%;" data-animate-effect="fadeIn">
                <div href="{{route('HomeGuestSingle',['homeguestslug'=>$guesthouse->IDs])}}"><img src="https://panobooking.com/AndroidFiles/GuestHouseImages/{{$guesthouse->GuestHouseName}}.jpg" class="img-responsive" onerror="this.onerror=null;this.src='images/image-placeholder.png';"/>
                    <div class="desc">
                        <span></span>
                        <h3>{{$guesthouse->GuestHouseName}}</h3>
                        <span>{{$guesthouse->City}}</span>
                        <span class="price">UGX {{$guesthouse->Prices}}</span>
                        <a class="btn btn-primary btn-outline" href="{{route('HomeGuestSingle',['homeguestslug'=>$guesthouse->IDs])}}">Book Now <i class="icon-arrow-right22"></i></a>
                    </div>
                </div>
            </div>   
            @endforeach
            ...
            <div class="col-md-12">
                <ul id="fh5co-destination-list" class="animate-box">
                    ...
                    <li class="one-forth text-center" style="background-image: url('https://panobooking.com/AndroidFiles/CityImages/{{$destination->City}}.jpg'); ">
                        <a href="{{route('HomeGuestsList',['destinationslug'=>$destination->City])}}">
                   ...
                   @endforeach
                    <li class="one-half text-center">
                        <div class="title-bg">
                            <div class="case-studies-summary">
                                ...
                                <span><a href="{{route('HomeGuestsList')}}">View All Destinations</a></span>
                            </div>
                        </div>
                    </li>
                    ...
                    <li class="one-forth text-center" style="background-image: url('https://panobooking.com/AndroidFiles/CityImages/{{$destinations->City}}.jpg'); ">
                        <a href="{{route('HomeGuestsList',['destinationslug'=>$destinations->City])}}">
                            <div class="case-studies-summary">
                   ...
                   <form wire:submit.prevent="submitfeedback" >
                    @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="clientcompany" placeholder="Addyour country here..." name="clientcompany" wire:model.lazy="clientcompany" required>
                        </div>

    ...
    <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6 fh5co-tours animate-box" data-animate-effect="fadeIn">
                    <div href="{{route('Cities',['cityslug'=>$destinations->Region,'countryslug'=>$destinations->Country])}}"><img src="images/place-2.jpg"  class="img-responsive" onerror="this.onerror=null;this.src='images/place-2.jpg';">
                        <div class="desc">
                            <span></span>
                            <h3>{{$destinations->Region}}</h3>
                            <span>{{$destinations->Country}}</span>
                            <a class="btn btn-primary btn-outline" href="{{route('Cities',['cityslug'=>$destinations->Region,'countryslug'=>$destinations->Country])}}">View Region's Cities<i class="icon-arrow-right22"></i></a>
                        </div>
                    </div>
                </div>   

        ...
        <div class="nav-header">
            ...
            <nav id="fh5co-menu-wrap" role="navigation">
                <ul class="sf-menu" id="fh5co-primary-menu">
                    ...
                    <!--<li ><a href="/homeguests">Home Guests</a></li>-->
                            ...
                            <div class="shop-widget-top">
                                <aside class="widget widget-categories">
                                    ...
                                    <ul class="sidebar-menu">
									    ...
									    <li>
                                        <a href='{{route('AmbulanceList',['ambulancecategoriesslug'=>$destination[0]->AmbulanceCategory])}}'>
                                            <i class='fa fa-angle-double-right'></i>{{ $destination[0]->AmbulanceCategory }}<span>({{$destination[0]->cnt}})</span>
                                        </a>
                                        </li>
                                        @endforeach                                             
                                    </ul>
                                           ...
                                           <div class='col-md-4 col-sm-6'>
											   <div class='single-banner'>
												   <div class='product-wrapper'>
													   <a href='{{route('AmbulanceDetails',['ambulanceslug'=>$carcategory->IDs])}}' class='single-banner-image-wrapper'>
														   <img  src="https://panobooking.com/AndroidDriver/FileUpload/{{$carcategory->TaxiNo}}.jpg" style="Height:180px; width:100%; border-radius:10px;" onerror="this.onerror=null;this.src='images/image-placeholder.png';"/>
														   <div class='price'><span> </div>
													    </a>
													   <div class='product-description'>
														   <div class='functional-buttons'>
															   <a href='{{route('AmbulanceDetails',['ambulanceslug'=>$carcategory->IDs])}}' title='Call'>
												   ...
												   <div class='banner-bottom2 text-center'>
													   <div class='banner-bottom-title'>
														   <a href='{{route('AmbulanceDetails',['ambulanceslug'=>$carcategory->IDs])}}'>{{$carcategory->TaxiNo}}</a>
													   </div>
                                       ...
                                       <div class='row'>
                                           <div class='single-shop-product'>
                                               <div class='col-xs-12 col-sm-5 col-md-6'>
                                                   <div class='left-item'>
                                                       <a href='{{route('AmbulanceDetails',['ambulanceslug'=>$carcategory->IDs])}}' title='{{$carcategory->TaxiNo}}' >
                                                           <img src='https://panobooking.com/AndroidDriver/FileUpload/{{$carcategory->TaxiNo}}.jpg' style='Height:250px;width:100%;border-radius:10px;' onerror="this.onerror=null;this.src='images/image-placeholder.png';"/>
                                                       </a>
                                                   </div>
                                               </div>
                                               <div class='col-xs-12 col-sm-7 col-md-6'>
                                                   <div class='deal-product-content'>
                                                       <h4>
                                                           <a href='{{route('AmbulanceDetails',['ambulanceslug'=>$carcategory->IDs])}}' title='{{$carcategory->TaxiNo}}'>{{$carcategory->TaxiNo}}</a>
                                                       </h4>
                                                       ...
                                                       <div class='availability'>
                                                           <span>Available</span>
                                                           <span><a href='{{route('AmbulanceDetails',['ambulanceslug'=>$carcategory->IDs])}}'>Call</a></span>
                                                       </div>
                                                   </div>
                                               </div>
                                           </div>  

                            ...
                            <div class="shop-widget-top">
                                <aside class="widget widget-categories">
                                    ...
                                    <ul class="sidebar-menu">
									    ...
									    <li>
                                        <a href='{{route('DestinationsList',['destinationslug'=>$destination[0]->City])}}'>
                                           ...
                                           <div class='col-md-4 col-sm-6'>
											   <div class='single-banner'>
												   <div class='product-wrapper'>
													   <a href='{{route('HotelSingle',['hotelslug'=>$hotel->IDs])}}' class='single-banner-image-wrapper'>
														   <img  src="https://panobooking.com/AndroidFiles/DestinationImages/{{$hotel->Place}}.jpg" style="Height:250px; width:100%;border-radius:10px;" onerror="this.onerror=null;this.src='images/image-placeholder.png';"/>
														   <div class='price'><span>{!!$currencypick!!}.</span>{{number_format(ceil($hotel->Prices/$currenyvalue),0)}}</div>
													</a>
													   <div class='product-description'>
														   <div class='functional-buttons'>
															   <a href='{{route('HotelSingle',['hotelslug'=>$hotel->IDs])}}' title='Reserve'>
												   ...
												   <div class='banner-bottom text-center'>
													   <div class='banner-bottom-title'>
														   <a href='{{route('HotelSingle',['hotelslug'=>$hotel->IDs])}}'>{{$hotel->Place}}</a>
													   </div>
                                                       @if($hotel->Rating==5)
                                       ...
                                       <div class='row'>
                                           <div class='single-shop-product'>
                                               <div class='col-xs-12 col-sm-5 col-md-4'>
                                                   <div class='left-item'>
                                                       <a href='{{route('HotelSingle',['hotelslug'=>$hotel->IDs])}}' title='{{$hotel->Place}}'>
                                                           <img src='https://panobooking.com/AndroidFiles/DestinationImages/{{$hotel->Place}}.jpg' alt='' style='Height:250px;width:100%;border-radius:10px;' onerror="this.onerror=null;this.src='images/image-placeholder.png';"/>
                                                       </a>
                                                   </div>
                                               </div>
                                               <div class='col-xs-12 col-sm-7 col-md-8'>
                                                   <div class='deal-product-content'>
                                                       <h4>
                                                           <a href='{{route('HotelSingle',['hotelslug'=>$hotel->IDs])}}' title='{{$hotel->Place}}'>{{$hotel->Place}}</a>
                                                       </h4>
                                                       <div class='product-price'>
                                                           <span class='new-price'>  {!!$currencypick!!}. {{number_format(ceil($hotel->Prices/$currenyvalue),0)}}</span>
                                                       ...
                                                       <div class='availability'>
                                                           <span>Available</span>
                                                           <span><a href='{{route('HotelSingle',['hotelslug'=>$hotel->IDs])}}'>Reserve</a></span>
                                                       </div>
                                                   </div>
                                               </div>
                                           </div>  

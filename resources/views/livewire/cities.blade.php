    ...
    <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6 fh5co-tours animate-box" data-animate-effect="fadeIn">
                    <div href="#"><img src="https://panobooking.com/AndroidFiles/CityImages/{{$destinations->City}}.jpg"  class="img-responsive" onerror="this.onerror=null;this.src='images/image-placeholder.png';">
                        <div class="desc">
                            <span class="price">{{$destinations->City}}</span>
                            <h3>{{$destinations->Region}}</h3>
                            <span>{{$destinations->Country}}</span>
                            <a class="btn btn-primary btn-outline" href="{{route('Properties',['cityslug'=>$destinations->City,'countryslug'=>$destinations->Country])}}">View Properties<i class="icon-arrow-right22"></i></a>
                        </div>
                    </div>
                </div>   

                ...
                <div class="row">
                    <div class="col-sm-5 col-md-5">
                        ...
                        <div id="mydesc" class="col-sm-7 col-sm-push-1 col-md-7 col-md-push-1">
                            ...
                            <h3>Next Readily Available Taxi</h3>
                            <span class="price">{{$offeredroom->TaxiNo}}</span>
                            <p><a class="btn btn-info btn-lg" href="{{route('TaxiDetails',['taxislug'=>$offeredroom->IDs])}}">Order Now</a></p>
                            @endforeach
                        </div>
                        @else
                        <div id="mydesc"  class="col-sm-7 col-sm-push-1 col-md-7 col-md-push-1">
                            <p>Ranked by <a href="panobooking.com" target="_blank" class="fh5co-site-name">panobooking.com</a></p>
                            <h3>Featured Taxi on Panobooking.com</h3>
                            @foreach ($hoteloffered as $hoteloffered)
                            <span class="price">{{$hoteloffered->TaxiNo}}</span>
                            <p><a class="btn btn-info btn-lg" href="{{route('TaxiDetails',['taxislug'=>$hoteloffered->IDs])}}">Order Now</a></p>
                            @endforeach
                        </div>
                        @endif
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8 col-md-offset-2 text-center heading-section animate-box">
                <h3>Ready Taxis For Rent</h3>
                <p>Worried about flight timing, here are our confortable airport taxis to your next flight. Book with us now.</p>
            </div>
        </div>
        <div class="row">
            ...
            <div class="item" >
                <div class="col-md-4 col-sm-6 fh5co-tours animate-box" style="width:100%;" data-animate-effect="fadeIn">
                    <div  href="{{route('TaxiDetails',['taxislug'=>$taxi->IDs])}}"><img src="https://panobooking.com/AndroidDriver/FileUpload/{{$taxi->TaxiNo}}.jpg" class="img-responsive" onerror="this.onerror=null;this.src='images/image-placeholder.png';"/>
                        <div class="desc">
                            <span></span>
                            <h3>{{$taxi->TaxiNo}}</h3>
                            <span>{{$taxi->CarSpec}}</span>
                            <span>{{ $taxi->CurrentLocation}}</span>
                            <span class="price"></span>
                            <a class="btn btn-primary btn-outline" href="{{route('TaxiDetails',['taxislug'=>$taxi->IDs])}}">Order Now <i class="icon-arrow-right22"></i></a>
                        </div>
                    </div>
                </div> 
            </div> 
        ...
        <div class="row">
            <div class="col-md-12">
                <ul id="fh5co-destination-list" class="animate-box">
                    ...
                    <li class="one-forth text-center" style="background-image: url('https://panobooking.com/AndroidDriver/FileUpload/CarCategory/{{$destination->CarCategory}}.jpg'); ">
                        <a href="{{route('TaxisList',['taxicategoriesslug'=>$destination->CarCategory ])}}">
                            <div class="case-studies-summary">
                                <h2 style="text-transform: uppercase;">{{$destination->CarCategory}}</h2>
                            </div>
                        </a>
                    </li>
                   @endforeach
                    <li class="one-half text-center">
                        <div class="title-bg">
                            <div class="case-studies-summary">
                                <h2>Most Popular Airport Taxi Categories</h2>
                                <span><a href="{{route('TaxisList')}}">View All Airport Taxi Categories</a></span>
                            </div>
                        </div>
                    </li>
                    @foreach ($seconddestinations as $destinations)
                    <li class="one-forth text-center" style="background-image: url('https://panobooking.com/AndroidDriver/FileUpload/CarCategory/{{$destinations->CarCategory}}.jpg'); ">
                        <a href="{{route('TaxisList',['taxicategoriesslug'=>$destinations->CarCategory ])}}">
                            <div class="case-studies-summary">
                                <h2 style="text-transform: uppercase;">{{$destinations->CarCategory}}</h2>
                            </div>
                        </a>
                    </li>
                    @endforeach 
        ...
        <div class="row" style="padding-bottom: 10px;">
            ...
            <div class="col-md-12">
                ...
                <div class="box-testimony animate-box">
                    ...
                    <p class="author">{{$clientfeedback->ClientName}}, {{$clientfeedback->ClientJob}}<a href="https://panobooking.com/" target="_blank">{{$clientfeedback->ClientCompany}}</a> <span class="subtext">{{$clientfeedback->ClientJob}}</span></p>
                </div>  
            </div>
            </div>
           @endforeach
